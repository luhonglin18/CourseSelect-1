...
course_map={
    ...
    2 => {course_code: "091M4002H", name: "计算机网络", course_type: "专业核心课", credit: "60/3.0", limit_num: "0", course_week: "第2-20周	", course_time: "周五(2-4)", class_room: "教1-107", teaching_type: "课堂讲授为主", exam_type: "闭卷笔试"},
    3 => {course_code: "091M4021H-1", name: "高级软件工程", course_type: "一级学科核心课", credit: "60/3.0", limit_num: "0", course_week: "第2-20周	", course_time: "周四(9-11)", class_room: "教1-109", teaching_type: "授课、讨论	", exam_type: "闭卷笔试"},
    4 => {course_code: "091M4021H-2", name: "高级软件工程", course_type: "一级学科核心课", credit: "60/3.0", limit_num: "0", course_week: "第2-20周	", course_time: "周三(9-11)", class_room: "教1-109", teaching_type: "授课、讨论	", exam_type: "闭卷笔试"},
    5 => {course_code: "091M4023H", name: "数理逻辑与程序理论", course_type: "专业核心课", credit: "60/3.0",  limit_num: "0",course_week: "第2-20周	", course_time: "周二(5-7)", class_room: "教1-113", teaching_type: "课堂讲授为主", exam_type: "闭卷笔试"},
    ...
    8 => {course_code: "091M4043H", name: "高级人工智能", course_type: "专业核心课", credit: "60/3.0", limit_num: "0", course_week: "第2-20周", course_time: "周二(9-11)", class_room: "教1-107", teaching_type: "课堂讲授为主", exam_type: "闭卷笔试"},
    9 => {course_code: "091M5001H", name: "VLSI测试与可测试性设计", course_type: "专业普及课", credit: "40/2.0", limit_num: "0", course_week: "第2-16周	", course_time: "周二(9-11)", class_room: "教1-109", teaching_type: "课堂讲授为主", exam_type: "课堂开卷"},
    10 => {course_code: "091M5004H", name: "超大规模集成电路基础", course_type: "专业普及课", credit: "40/2.0", limit_num: "0", course_week: "第2-16周	", course_time: "周四(5-7)", class_room: "教1-413", teaching_type: "课堂讲授为主", exam_type: "课堂开卷"},
    ...
    12 => {course_code: "091M5024H", name: "编译程序高级教程", course_type: "专业普及课", credit: "40/2.0", limit_num: "0", course_week: "第2-18周	", course_time: "周一(5-7)", class_room: "教1-108", teaching_type: "课堂讲授为主", exam_type: "课堂开卷"},
    13 => {course_code: "091M5025H", name: "操作系统高级教程", course_type: "专业普及课", credit: "40/2.0", limit_num: "0", course_week: "第2-12周	", course_time: "周三(7-8)", class_room: "教1-101", teaching_type: "课堂讲授为主", exam_type: "课堂开卷"},
    14 => {course_code: "091M5026H", name: "并发数据结构与多核编程", course_type: "专业普及课", credit: "40/2.0", limit_num: "0", course_week: "第2-17周	", course_time: "周四(5-7)", class_room: "教1-109", teaching_type: "课堂讲授为主", exam_type: "课堂开卷"},
    15 => {course_code: "091M5027H", name: "形式语言与自动机理论", course_type: "专业普及课", credit: "40/2.0", limit_num: "0", course_week: "第2-17周	", course_time: "周五(5-7)", class_room: "教1-113", teaching_type: "课堂讲授为主", exam_type: "课堂开卷"},
    16 => {course_code: "091M5041H", name: "人机交互", course_type: "专业普及课", credit: "40/2.0", limit_num: "0", course_week: "第2-17周", course_time: "周三(5-7)", class_room: "教1-108", teaching_type: "课堂讲授为主", exam_type: "课堂开卷"},
    17 => {course_code: "091M5042H", name: "网络数据挖掘", course_type: "专业普及课", credit: "40/2.0", limit_num: "0", course_week: "第2-17周	", course_time: "周二(5-7)", class_room: "教1-107", teaching_type: "课堂讲授为主", exam_type: "闭卷笔试"},
    ...
    20 => {course_code: "092M4001H", name: "最优控制理论", course_type: "专业核心课", credit: "60/3.0", limit_num: "0", course_week: "第3-6,8-20周	", course_time: "周二(3-4)", class_room: "教1-109", teaching_type: "课堂讲授为主", exam_type: "闭卷笔试"},
    21 => {course_code: "092M4002H", name: "模式识别", course_type: "专业核心课", credit: "60/3.0", limit_num: "0", course_week: "第2-20周	", course_time: "周三(9-11)", class_room: "教1-102", teaching_type: "课堂讲授为主", exam_type: "闭卷笔试"},
    22 => {course_code: "092M4022H", name: "人工智能理论与实践", course_type: "专业核心课", credit: "60/3.0", limit_num: "0", course_week: "第2-20周	", course_time: "周四(9-11)", class_room: "教1-109", teaching_type: "授课、讨论	", exam_type: "闭卷笔试"},
    23 => {course_code: "092M4023H", name: "图像处理与分析", course_type: "专业核心课", credit: "60/3.0", limit_num: "0", course_week: "第2-4,6-18周	", course_time: "周二(1-2)", class_room: "教1-102", teaching_type: "课堂讲授为主", exam_type: "闭卷笔试"},
    24 => {course_code: "092M5002H", name: "机器人学导论", course_type: "专业普及课", credit: "40/2.0", limit_num: "0", course_week: "第2-16周	", course_time: "周五(5-7)", class_room: "教1-109", teaching_type: "课堂讲授为主", exam_type: "课堂开卷"},
    25 => {course_code: "092M5006H", name: "矩阵分析与应用", course_type: "专业普及课", credit: "40/2.0", limit_num: "0", course_week: "第2-12周	", course_time: "周三(1-2)", class_room: "教1-102", teaching_type: "课堂讲授为主", exam_type: "闭卷笔试"},
    26 => {course_code: "092M5025H", name: "现代信息检索", course_type: "专业普及课", credit: "40/2.0", limit_num: "0", course_week: "第2-12周	", course_time: "周三(3-4)", class_room: "教1-109", teaching_type: "课堂讲授为主", exam_type: "课堂开卷"},
    27 => {course_code: "092M5026H", name: "随机过程", course_type: "专业普及课", credit: "40/2.0", limit_num: "0", course_week: "第2-17周	", course_time: "周三(5-7)", class_room: "教1-109", teaching_type: "课堂讲授为主", exam_type: "读书报告"},
    ...
    33 => {course_code: "093M2007H", name: "数据库新技术", course_type: "一级学科普及课", credit: "40/2.0", limit_num: "0", course_week: "第2-12周	", course_time: "周一(3-4)", class_room: "教1-107", teaching_type: "课堂讲授为主", exam_type: "闭卷笔试"},
